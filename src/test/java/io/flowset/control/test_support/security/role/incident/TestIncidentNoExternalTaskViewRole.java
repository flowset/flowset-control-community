...
@ResourceRole(
        name = "Test Access: incident without external task view",
        code = TestIncidentNoExternalTaskViewRole.CODE,
        scope = SecurityScope.UI
)
public interface TestIncidentNoExternalTaskViewRole extends UiMinimalRole {

    String CODE = "test-incident-no-external-task-view";
