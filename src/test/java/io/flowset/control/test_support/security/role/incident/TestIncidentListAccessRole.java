...
@ResourceRole(
        name = "Test Access: incident list and detail",
        code = TestIncidentListAccessRole.CODE,
        scope = SecurityScope.UI
)
public interface TestIncidentListAccessRole extends UiMinimalRole {

    String CODE = "test-incident-list-access";
