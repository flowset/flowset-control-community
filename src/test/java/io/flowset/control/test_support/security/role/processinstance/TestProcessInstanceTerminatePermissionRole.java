...
@ResourceRole(
        name = "Test Permission: process instance terminate",
        code = TestProcessInstanceTerminatePermissionRole.CODE,
        scope = SecurityScope.UI
)
public interface TestProcessInstanceTerminatePermissionRole extends TestUiPermissionFullAccessReadRole {

    String CODE = "test-process-instance-terminate-permission";
