...
@ResourceRole(
        name = "Test Access: process instance list without detail view",
        code = TestProcessInstanceListNoDetailViewRole.CODE,
        scope = SecurityScope.UI
)
public interface TestProcessInstanceListNoDetailViewRole extends TestMainMenuProcessInstanceRole {

    String CODE = "test-process-instance-list-no-detail-view";
