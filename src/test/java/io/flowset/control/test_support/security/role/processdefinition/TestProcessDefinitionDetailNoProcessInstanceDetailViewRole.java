...
@ResourceRole(
        name = "Test Access: process definition detail without process instance detail view",
        code = TestProcessDefinitionDetailNoProcessInstanceDetailViewRole.CODE,
        scope = SecurityScope.UI
)
public interface TestProcessDefinitionDetailNoProcessInstanceDetailViewRole extends TestMainMenuProcessDefinitionRole {

    String CODE = "test-process-definition-detail-no-process-instance-detail-view";
