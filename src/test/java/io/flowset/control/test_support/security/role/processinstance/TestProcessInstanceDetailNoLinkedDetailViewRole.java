...
@ResourceRole(
        name = "Test Access: process instance detail without linked detail views",
        code = TestProcessInstanceDetailNoLinkedDetailViewRole.CODE,
        scope = SecurityScope.UI
)
public interface TestProcessInstanceDetailNoLinkedDetailViewRole extends UiMinimalRole {

    String CODE = "test-process-instance-detail-no-linked-detail-view";

    @ViewPolicy(viewIds = {"bpm_ProcessInstance.list", "bpm_ProcessInstanceData.detail"})
    @MenuPolicy(menuIds = "*")
    void uiAccess();
    ...
    @EntityAttributePolicy(entityClass = HistoricDecisionInputInstanceShortData.class, attributes = "*",
            action = EntityAttributePolicyAction.VIEW)
    ...
    @EntityAttributePolicy(entityClass = HistoricDecisionOutputInstanceShortData.class, attributes = "*",
            action = EntityAttributePolicyAction.VIEW)
