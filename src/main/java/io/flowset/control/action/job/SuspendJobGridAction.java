...
@ActionType(SuspendJobGridAction.ID)
public class SuspendJobGridAction extends ListDataComponentAction<SuspendJobGridAction, JobData> {

    public static final String ID = "control_suspendGridJob";
    ...
    public SuspendJobGridAction() {
        super(ID);
    }

    public SuspendJobGridAction(String id) {
        super(id);
    }
    ...
    protected boolean isApplicable() {
        ...
        return super.isApplicable()
                && selectedJob != null
                && selectedJob.getState() == JobState.ACTIVE;
    }
}
