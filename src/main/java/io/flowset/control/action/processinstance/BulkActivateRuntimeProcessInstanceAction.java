...
@ActionType(BulkActivateRuntimeProcessInstanceAction.ID)
public class BulkActivateRuntimeProcessInstanceAction
        extends ListDataComponentAction<BulkActivateRuntimeProcessInstanceAction, RuntimeProcessInstanceData> {

    public static final String ID = "control_bulkActivateRuntimeProcessInstance";
    ...
    public BulkActivateRuntimeProcessInstanceAction() {
        super(ID);
    }

    public BulkActivateRuntimeProcessInstanceAction(String id) {
        super(id);
    }
    ...
    protected boolean isApplicable() {
        ...
        return target.getSelectedItems().stream()
                .anyMatch(item -> BooleanUtils.isTrue(item.getSuspended()));
    }
}
