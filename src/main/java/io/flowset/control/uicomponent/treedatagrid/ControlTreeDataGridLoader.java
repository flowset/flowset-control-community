...
/**
 * Extends the functionality of TreeDataGridLoader by adding a default empty state component when no specific
 * empty state component or text is provided.
 */
public class ControlTreeDataGridLoader extends TreeDataGridLoader {
